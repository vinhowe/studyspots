...
<body>
        ...
        <main>
                ...
                <h1>Open BYU classrooms fall semester 2019 for <?php echo "$dayname" ?> (MST)</h1>
                ...
                <p>Classrooms are sorted (in order):</p>
                <ol>
                ...
                <p>No guarantees are made on the accuracy of this information. Use BYU's <a href="https://y.byu.edu/ry/ae/prod/class_schedule/cgi/examDailySchedule.cgi" target="_blank">daily exam schedule</a> page to check when exams will be held in classrooms.</p>
...
<script type="text/javascript">
        ...
        function openPopup(bldg, room) {
                let imageUrl = `http://${window.location.host}/360.html?bldg=${bldg}&room=${room}`
